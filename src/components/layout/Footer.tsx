      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Embark on an unforgettable journey through mystical realms filled
              with magic, danger, and endless adventure.
            </p>
            <div className="flex space-x-4">
              <button
                type="button"
                className="text-white hover:text-[var(--isle-fire)] transition-colors"
                aria-label="Twitter"
                aria-disabled="true"
                tabIndex={-1}
                style={{
              ...
              <button
                type="button"
                className="text-white hover:text-[var(--isle-ice)] transition-colors"
                aria-label="Discord"
                aria-disabled="true"
                tabIndex={-1}
                style={{
              ...
              <button
                type="button"
                className="text-white hover:text-[var(--isle-desert)] transition-colors"
                aria-label="YouTube"
                aria-disabled="true"
                tabIndex={-1}
                style={{
              ...
              <a
                ...
                className="text-white hover:text-[var(--isle-crystal)] transition-colors"
                aria-label="GitHub"
                target="_blank"
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-500 text-xs">
            Stormbound Isles is not affiliated with, endorsed by, or related to
            Mojang Studios or Microsoft. This is an independent fan project.
          </p>
        </div>
      </div>
    </footer>
